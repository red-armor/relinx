...
export declare type ProxyTrackerFunctions = InternalFunction;
export declare type ProxyTrackerInterface = ProxyTrackerProperties & ProxyTrackerFunctions;
export interface ProxyTrackerConstructor {
    new ({ accessPath, parentProxy, rootPath, base, trackerNode, useRevoke, useScope, }: ProxyTrackerConstructorProps): ProxyTrackerInterface;
}
