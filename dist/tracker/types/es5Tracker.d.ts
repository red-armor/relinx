...
export declare type ES5TrackerProperties = {
    id: string;
    trackerNode: TrackerNode;
    accessPath: Array<string>;
    rootPath: Array<string>;
...
export declare type ES5TrackerFunctions = InternalFunction;
export declare type ES5TrackerInterface = ES5TrackerProperties & InternalFunction;
export interface ES5TrackerConstructor {
    new ({ accessPath, parentProxy, rootPath, base, trackerNode, useRevoke, useScope, }: ES5TrackerConstructorProps): ES5TrackerInterface;
}
