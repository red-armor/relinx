...
By default, its value is false. Normally, it is used on dev condition. It helps to log the undeclared properties used by `state`. It's meaningful when `ES5` should be supported
